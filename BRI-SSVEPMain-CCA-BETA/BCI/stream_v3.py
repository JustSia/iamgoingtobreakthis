...
class StreamV3(threading.Thread):
    ...
    def get_stream(self):
        st = resolve_stream('type', 'BFSample')
        # print("list:", list(st))
        for s in st:
            print(s.name())
    ...
    def run(self):
        ...
        while self.serstatus == 1:
            ...
            try:
                ...
                sample = np.array(sample).transpose()[1:5, :]  # Channel X timepoints
                # print(sample.shape)
...
if __name__ == '__main__':
    ...
    mindo = StreamV3(stream_name="Cyton8_BFSample", srate=250, channels=4)
