...
if __name__ == '__main__':
    ...
    feed_back_PORT = 5006
    # feed_back_IP = my_ip # control PC IP
    feed_back_IP1 = "192.168.0.202"              # control PC IP (The first pc running main)      <-----  Change here
    feed_back_IP2 = "192.168.0.19"              # control PC IP (The second pc running main)     <-----  Change here
