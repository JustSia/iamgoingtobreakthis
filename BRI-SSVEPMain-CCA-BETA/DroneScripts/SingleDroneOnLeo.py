...
uris = [
    'radio://0/30/2M/E7E7E7E7E7',  # cf_id 0, startup position [ 0, +0.4 ]     (Left)
]


droneMiddle = [  # Crazy-30 (Light)
     (0, 0, h+h, flight_time),      # Highest 7
     (0, 0, h-0.1, flight_time),      # Lowest  8   (Starting Pos)
     (-rangee,  rangee, h, flight_time),        # x
     (-rangee+0.5, 0      , h, flight_time),        # Pos5
     (-rangee, -rangee, h, flight_time),        # x
     ( rangee,  rangee, h+h, flight_time),      # Pos6
     ( rangee+0.4, -rangee+0.2    , h+h, flight_time),      # Pos3
    ...
    with Swarm(uris, factory=factory) as swarm:
        ...
        while True:
            ...
            if BRI_command == 1 :
                ...
                print('1 - No Command for Drone')

            elif BRI_command == 2 :

                print('2 - No Command for Drone')
