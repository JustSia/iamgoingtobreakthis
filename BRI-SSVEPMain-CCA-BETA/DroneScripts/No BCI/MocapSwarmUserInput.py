...
# Working with mocap and BCI 20/03/2023 ---------------------------------------------------------------------------
# TWO Drones  (With Full Pose from optiTrack!!!)
# 20/March/2023 !!!!!!!
...
# uri40 = uri_helper.uri_from_env(default='radio://0/40/2M/E7E7E7E7E7')            # Blue (stepped on)   (initially firmware broken but fixed)
...
def user_input(cf10, cf20, range, flight_time):   
    ...
    while True:
        ...
        if usrInput == 't':
            ...
            cf10.high_level_commander.go_to(0, 0, 1.0, 0, flight_time, relative)
            cf20.high_level_commander.go_to(0, 0+differences, 1.0, 0, flight_time, relative)
            print('Pos 0')
    ...
    try:
        with SyncCrazyflie(uri10, cf=Crazyflie(rw_cache='./cache')) as scf10:
            ...
            with SyncCrazyflie(uri20, cf=Crazyflie(rw_cache='./cache')) as scf20:
                ...
                user_input(drone10, drone20, 0.8, 3)
                # ---------------------------------
